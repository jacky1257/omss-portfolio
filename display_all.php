...
<head>
  ...
  function myFunction1() {
    var dropdownContent = document.getElementById("categories");
  ...
  function myFunction2() {
    var dropdownContent = document.getElementById("brands");
    if (dropdownContent.style.display === "none") {
      dropdownContent.style.display = "block";
    } else {
      dropdownContent.style.display = "none";
...
<div class="drop">
  <button onclick="myFunction1()" class="dropbtn">Categories</button>
...
<footer class=footer_admin >
  <div>
    <p>All rights reserved @- Designed By Jacky-2023/2024</p>
  </div>
</footer>
</html>